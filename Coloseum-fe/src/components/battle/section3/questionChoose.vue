<template>
  <div class="jumbotron">
    <h4>
      Choose question difficult level:
      <h3>{{ level }}</h3>
    </h4>
    <div class="questionChoose">
      ...
      <button
        ...
        :disabled="questionLimit.normal === 0"
      >
        Normal (20 points)
      </button>
      <button
        ...
        @click="setLevel('hard')"
        :disabled="questionLimit.hard === 0"
      >
        Hard (30 points)
      </button>
      <button
        class="btn btn-danger"
        @click="setLevel('death')"
        :disabled="questionLimit.death === 0"
      >
        Blood and borne (40 points)
      </button>
    </div>
